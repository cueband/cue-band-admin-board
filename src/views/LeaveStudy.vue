        ...
        <div class="col-12">
          <div class="nav nav-pills p-2" style="display: flex; flex-direction: column">
            ...
            <div style="display: flex; flex-direction: row; gap: 20px;"> 
              ...
              <div>
                <input type="radio" id="studyDataId" value="studyDataId" name="searchType" v-model="searchMode"/>
                <label for="address">StudyDataID</label>
              </div>
              <div>
                <input type="radio" id="userId" value="userId" name="searchType" v-model="searchMode"/>
                <label for="address">UserID</label>
              </div>
            </div>
  ...
  methods: {
    ...
    async onSearch() {
      ...
      if(this.searchMode == "email") {
        ...
        //this.setResult(this.searchResults);
      } else if(this.searchMode == "studyDataId") {
        console.log("searching by study data id");
        this.searchResults = await api.SearchByStudyDataId(this.searchTerm);
        //this.setResult(this.searchResults);
      } else if(this.searchMode == "userId") {
        this.searchResults = await api.SearchByUserId(this.searchTerm);
        //this.setResult(this.searchResults);
      }
