<template>
  ...
  >
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-collapse navText="Study Starting Emails" :to="{ name: 'Study Starting Emails' }">
          <template #icon>
            <document />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse navText="Send Start Email" :to="{ name: 'Send Start Email' }">
          <template #icon>
            <box3d />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse navText="Participant Search" :to="{ name: 'Participant Info' }">
          <template #icon>
            <box3d />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse navText="Leave Study" :to="{ name: 'Leave Study' }">
          <template #icon>
            <box3d />
          </template>
        </sidenav-collapse>
